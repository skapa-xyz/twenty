...
// Backwards compatibility exports - these will be deprecated
export const FIND_PROPERTIES_IN_BOUNDS = PROPERTIES_IN_BOUNDING_BOX;
export const GET_PROPERTY_DETAILS = GET_PROPERTY;
